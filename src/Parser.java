...
public class Parser implements Constants
{
    ...
    private FunctionSymbolTabLe ft;
    //the function we are working in
    private String currentfunction;
    public Parser(SymbolTable st, TokenMgr tm, PrintWriter outFile)
    {
        this.st = st;
        this.tm = tm;
        this.outFile = outFile;
        this.identifiercount = 0;
        this.rm = new RegisterMgr();
        ...
        this.ft = new FunctionSymbolTabLe("main");
    ...
    private void globalDeclarations()
    {
        switch (currentToken.kind)
        {
            case INT:
                ...
                emitInstruction("addi","$gp","$gp","4","#Space for variable: "+nameGloble); // Spare some space for global variables
                consume(ID);
                globalTail();
                consume(SEMICOLON);
                globalDeclarations();
    ...
    {
        consume(INT);
        //enter the args into the symbol table of this function
    ...
    /**
     * This function is defined in order to unify the "load" operation from local variables and global variables
     * */
    private void loadVariable(String reg,String var)
    {
         ...
         * Then we need some code to load variable into register
         * ********/
        if(var.indexOf('[') > 0 && var.indexOf(']') > 0)
        {
            ...
            System.out.println("index of the global variable: "+index);
    ...
    private void assignmentStatement()
    {
        ...
        outFile.println("#Assignment statement for variable: "+left_op);
